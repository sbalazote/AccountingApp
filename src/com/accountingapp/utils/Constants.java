...
public final class Constants {
	...
	/** tipo de factura "A" */
	public static final int TAX_SALE_A_TYPE_BILL_CELL_NUM = 4;

	/** fecha de factura A */
	public static final int TAX_SALE_A_TYPE_BILL_DATE_CELL_NUM = 5;

	/** numero de comprobante factura A */
	public static final int TAX_SALE_A_TYPE_BILL_NUMBER_CELL_NUM = 6;

	/** apellido y nombre del comprador factura A */
	public static final int TAX_SALE_A_TYPE_BILL_BUYER_FULLNAME_CELL_NUM = 7;

	/** numero de identificacion del comprador factura A */
	public static final int TAX_SALE_A_TYPE_BILL_BUYER_ID_NUMBER_CELL_NUM = 9;

	/** importe total operacion */
	public static final int TAX_SALE_A_TYPE_BILL_TOTAL_PRICE_OPERATION_CELL_NUM = 12;

	/** FILA INICIAL IVA VENTAS FACTURAS B */
	public static final int TAX_SALES_B_TYPE_BILL_INITIAL_ROW_NUM = 66;

	/** tipo de factura "B" */
	public static final int TAX_SALE_B_TYPE_BILL_CELL_NUM = 4;

	/** numero de comprobante factura B */
	public static final int TAX_SALE_B_TYPE_BILL_NUMBER_CELL_NUM = 6;

	/** importe total operacion */
	public static final int TAX_SALE_B_TYPE_BILL_TOTAL_PRICE_OPERATION_CELL_NUM = 12;
